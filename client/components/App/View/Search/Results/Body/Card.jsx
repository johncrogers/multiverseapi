  ...
  constructor(props) {
    ...
    this.state = {
      ...
      colorCodes: {
        ...
        B: ["b", ["rgba(168, 163, 153, .3)"]],
        W: ["w", ["rgba(255, 204, 102, .2)"]],
        "G/U": ["gu", ["rgba(28, 201, 64, .2)", "rgba(28, 145, 201, .2)"]],
        "B/G": ["bg", ["rgba(168, 163, 153, .3)", "rgba(28, 201, 64, .2)"]],
        "B/R": ["br", ["rgba(168, 163, 153, .3)", "rgba(255, 102, 0, .2)"]],
        "U/B": ["ub", ["rgba(28, 145, 201, .2)", "rgba(168, 163, 153, .3)"]],
        ...
        "W/B": ["wb", ["rgba(255, 204, 102, .2)", "rgba(168, 163, 153, .3)"]],
